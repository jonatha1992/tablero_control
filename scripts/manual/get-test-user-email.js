...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/mp-login.png' });
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/mp-login-user.png' });

    // Continuar
    const continueBtn = page.locator('button[type="submit"], button:has-text("Continuar"), button:has-text("Continue")').first();
    await continueBtn.click();
    await page.waitForTimeout(2000);
    await page.screenshot({ path: 'scripts/manual/artifacts/mp-login-after-user.png' });
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/mp-after-login.png' });
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/mp-test-users.png' });
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/mp-error.png' }).catch(() => {});
  } finally {
    await browser.close();
  }
})();
