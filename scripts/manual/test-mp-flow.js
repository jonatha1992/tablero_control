...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/ss-billing.png', fullPage: true });
    ...
    await page.screenshot({ path: 'scripts/manual/artifacts/ss-final.png', fullPage: true });

  } catch (err) {
    console.error('Error:', err.message);
    await page.screenshot({ path: 'scripts/manual/artifacts/ss-error.png', fullPage: true }).catch(() => {});
  } finally {
    await browser.close();
  }
})();
