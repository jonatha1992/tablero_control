  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground text-xs mt-0.5">Métricas y analíticas del negocio</p>
      </div>
      <div className="p-8 border-2 border-dashed rounded-lg text-center text-muted-foreground">
        <p className="text-sm">Próximamente — Módulo de reportes en desarrollo</p>
      </div>
>>>>>>> test
    </div>
  );
