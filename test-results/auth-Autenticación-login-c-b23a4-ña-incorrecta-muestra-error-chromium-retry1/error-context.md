...
- Name: auth.spec.ts >> Autenticación >> login con contraseña incorrecta muestra error
      ...
      - generic [ref=e24]:
        - generic [ref=e25]:
          ...
          - textbox "Correo" [ref=e26]:
            ...
            - text: tecnofusion.it@gmail.com
        - generic [ref=e27]:
          - generic [ref=e28]:
            - generic [ref=e29]: Contraseña
            - link "¿Olvidaste tu contraseña?" [ref=e30] [cursor=pointer]:
              - /url: /forgot-password
          - textbox "Contraseña" [ref=e31]: contraseña-incorrecta-123
