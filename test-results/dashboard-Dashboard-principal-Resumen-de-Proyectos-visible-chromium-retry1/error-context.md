...
- Name: dashboard.spec.ts >> Dashboard principal >> Resumen de Proyectos visible
- Location: tests\dashboard.spec.ts:47:7
...
Locator: getByRole('heading', { name: 'Resumen de Proyectos' }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Resumen de Proyectos' }).first()
