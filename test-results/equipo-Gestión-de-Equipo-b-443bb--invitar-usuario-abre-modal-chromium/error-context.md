...
- Name: equipo.spec.ts >> Gestión de Equipo >> botón crear/invitar usuario abre modal
- Location: tests\equipo.spec.ts:39:7
...
Locator: locator('button:has-text("Invitar"), button:has-text("Nuevo miembro"), button:has-text("Crear usuario"), button:has-text("Crear Usuario")').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Invitar"), button:has-text("Nuevo miembro"), button:has-text("Crear usuario"), button:has-text("Crear Usuario")').first()
