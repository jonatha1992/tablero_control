...
- Name: sectores.spec.ts >> Gestión de Sectores / ABM >> página carga con botón "Nuevo Departamento"
- Location: tests\sectores.spec.ts:12:7
...
Locator: locator('button:has-text("Nuevo Departamento")')
Expected: visible
Timeout: 10000ms
